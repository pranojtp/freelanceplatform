...
const Freelancer_sidebar = () => {
    ...
    return (
        <>
            <div className="h-screen w-80 flex flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-gray-800 px-6 p-4">
                <div className="relative flex flex-col h-16 shrink-0 mb-4">
                    <h1 className="text-xl font-bold mb-4 text-white">Welcome Freelancer</h1>
                    <p className="text-m text-white">Explore Freelancehub</p>
                </div>
                    ...
                    {navigation.map((item) => {
                        return (
                            <a
                                key={item.name}
                                href={item.href}
                                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-800 hover:bg-neutral-500 text-white font-medium text-m"
                            >
                                {item.name}
                            </a>
                        );
